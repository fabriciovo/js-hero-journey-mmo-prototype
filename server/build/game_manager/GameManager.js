    ...
    value: function setupEventListeners() {
      ...
      this.io.on("connection", function (socket) {
        ...
        socket.on("disconnect", function () {
          ...
          delete _this2.players[socket.id];
            ...
            return _regenerator["default"].wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                ...
                case 5:
                  ...
                  _this2.spawnPlayer(socket.id, name, key, playerSchema.player);
                  ...
                  socket.emit("currentNpcs", _this2.npcs);
        ...
        socket.on("attackedPlayer", function (attackedPlayerId) {
          if (_this2.players[attackedPlayerId]) {
            ...
            _this2.players[attackedPlayerId].playerAttacked(playerAttackValue);
            ...
            if (_this2.players[attackedPlayerId].health <= 0) {
              ...
              _this2.io.emit("respawnPlayer", _this2.players[attackedPlayerId]);
              ...
              _this2.io.to("".concat(attackedPlayerId)).emit("updateScore", _this2.players[attackedPlayerId].gold);
        ...
        socket.on("monsterAttacked", function (monsterId, dis) {
          ...
          if (_this2.monsters[monsterId]) {
            ...
            _this2.monsters[monsterId].loseHealth(playerAttackValue);
        ...
        socket.on("monsterAttack", function (monsterId, playerId) {
          ...
          _this2.io.emit("updatePlayerHealth", playerId, _this2.players[playerId].health);
          ...
          if (_this2.players[playerId].health <= 0) {
            ...
            socket.emit("updateScore", _this2.players[playerId].gold);
        ...
        socket.on("monsterMovement", function (monster) {
          ...
          _this2.monsters[monster.id].y = monster.y;
